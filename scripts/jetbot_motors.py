...
def on_cmd_str(msg):
	...
	if msg.data.lower() == "left":
		...
		set_speed(motor_left_ID,   0.86)
		set_speed(motor_right_ID,  0.86)
		...
		set_speed(motor_left_ID, 0.65)
		set_speed(motor_right_ID, 0.62)
